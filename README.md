...
Introduction
============
The Naive Bayes analytics consists of NaiveBayesTrainer and NaiveBayesClassifier plugins.
The plugins train a model based upon a particular label and text field of a record, using Naive Bayes algorithm,
and then uses the trained model to classify the data.
